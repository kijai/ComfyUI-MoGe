...
from  ...utils3d.torch import intrinsics_from_fov_xy, unproject_cv, image_uv
from huggingface_hub import hf_hub_download

from ..utils.geometry_torch import image_plane_uv, point_map_to_depth
...
class MoGeModel(nn.Module):
    ...
    def infer(
        ...
        if force_projection:
            points = unproject_cv(image_uv(width=expected_width, height=expected_height, dtype=points.dtype, device=points.device), depth, extrinsics=None, intrinsics=intrinsics[..., None, :, :])
        else:
